...
def main():
    ...
    #
    #facts = {'oradb_'+sid: { 'version': conn_version }}
    result['ansible_facts'] = {'oradb_'+sid: {'oraenv': {'ORACLE_SID': sid,'ORACLE_HOME': oracle_home}, 'version': conn_version, 'database': database, 'instance': instance, 'rac': rac, 'pdb': pdb, 'tablespace': tablespace, 'temp_tablespace': temp_tablespace, 'userenv': userenv, 'redolog': redolog, 'option': option, 'parameter': parameter}}
    
    #
    # module.exit_json(asg=msg[0], changed=False, ansible_facts.['oracle'][sid]=facts)
